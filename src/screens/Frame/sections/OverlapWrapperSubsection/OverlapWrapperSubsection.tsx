  ...
  return (
    <div className="w-full h-[1080px] bg-white relative">
      <div className="relative w-full max-w-[1884px] h-[1026px] top-[54px] left-9 mx-auto">
        ...
        {/* Mask Image */}
        <img
          className="absolute w-full max-w-[1040px] h-[970px] top-0 right-0 lg:right-[-40px] rounded-tr-[100px] rounded-br-[100px]"
          alt="Mask group"
          src="/Mask group.png"
        />
            ...
            <CardContent className="p-0">
              <div className="flex flex-col w-[436px] items-center gap-[49px] absolute top-56 left-[95px]">
                <div className="flex flex-col items-center gap-[19px] relative self-stretch w-full flex-[0_0_auto]">
                  ...
                  <img 
                    className="relative w-60 h-[52px]" 
                    alt="Success heading" 
                    src="/image (62).png" 
                  />
                ...
                <div className="relative w-[340px] h-[53px]">
                  <Button 
                    ...
                    className="w-[342px] h-[55px] bg-[#007fff] rounded-3xl hover:bg-[#0066cc] font-poppins font-semibold text-[#fafafb] text-2xl text-center"
                  >
                    Continue
                  </Button>
                </div>
