...
export const PropertyCommanSubsection = (): JSX.Element => {
  return (
    <div className="w-full h-auto bg-white relative">
      <div className="relative w-full max-w-[1884px] mx-auto px-9 pt-[54px]">
        <div className="relative w-full h-[971px] bg-[#edf0fa] rounded-[101px] overflow-hidden">
          ...
          <div className="absolute w-[627px] h-[858px] top-[57px] left-36">
            <Card className="w-[623px] h-[858px] shadow-[0px_4px_4px_#00000040,3px_-5px_40px_#cdcdd31a] rounded-[20px]">
              <CardContent className="p-0 relative w-full h-full">
                ...
                <div className="absolute top-[93px] left-[211px] [font-family:'Poppins',Helvetica] font-normal text-[#0062ff] text-5xl tracking-[0.12px] leading-[normal]">
                  ...
                  <span className="font-semibold text-[40px] tracking-[0.04px]">
                    &nbsp;
                  </span>
                </div>
                ...
                <div className="absolute w-[403px] h-[163px] top-[630px] left-[110px]">
                  <div className="absolute w-[400px] h-[15px] top-0 left-[3px]">
                    <div className="relative h-3.5">
                      <img
                        className="absolute w-[400px] h-0.5 top-[7px] left-0"
                        alt="Line"
                      />
                  ...
                  <div className="flex flex-col w-[403px] items-center gap-5 absolute top-[38px] left-0">
                    <div className="flex items-center justify-between relative self-stretch w-full flex-[0_0_auto]">
                      {socialLoginOptions.map((option, index) => (
                        <Button
                          key={option.name}
                          variant="outline"
                          className={`${option.width} h-auto flex items-center gap-2.5 px-5 py-1 rounded-xl border border-solid border-[#d9d9d9] bg-white hover:bg-gray-50`}
                        >
                          <img
                            className="w-6 h-6"
                            alt={option.name}
                    ...
                    <Button
                      variant="outline"
                      className="w-[190px] h-auto flex items-center justify-center gap-2.5 px-5 py-1 rounded-xl border border-solid border-[#d9d9d9] bg-white hover:bg-gray-50"
                    >
                      <img
                    ...
                    <div className="flex-col h-[22.98px] items-start inline-flex gap-2.5 relative">
                      <div className="relative w-[179px] h-[21px] mr-[-2.00px]">
                        <div className="absolute top-0 left-0 [font-family:'Poppins',Helvetica] font-medium text-transparent text-sm tracking-[0] leading-[normal]">
                          <span className="text-black">
                            Have an account?&nbsp;&nbsp;
                          </span>
                          <span className="text-[#007fff] cursor-pointer hover:underline">
                            Log In
                          </span>
                        </div>
                      </div>
